...
public class ReadWebServer extends AsyncTask<String, String, String> {
    ...
    private static final String myUserID = "3961497"; // [TODO] Fill in your ID. Your PERM number is ideal since it is a unique code that only you have access to.
    ...
    protected void onPostExecute(String result) {
        ...
        if (resultInt != 0) {
            lastAmount = resultInt;
            Toast.makeText(callingContext.get(), "Please select a card for the transaction", Toast.LENGTH_LONG).show();
        }
    }
